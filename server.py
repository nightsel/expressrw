...
def align_song_full():
    ...
    try:
        ...
        task = Task(config_string="task_language=eng|is_text_type=plain|os_task_file_format=json|log_level=TRACE|log_file_path_absolute=/tmp/aeneas_debug.log")
        ...
        if os.path.exists("/tmp/aeneas_debug.log"):
            ...
            print("📄 --- Aeneas debug log end ---", file=sys.stderr)
        else:
            print("⚠️ No Aeneas log file found", file=sys.stderr)
